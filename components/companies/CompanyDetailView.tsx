...
const mockCompanyStats: CompanyStats = {
  ...
  top_events: [
    ...
    { title: "Azure Developer Summit", attendees: 350, revenue: 17500 },
    { title: "Office 365 Workshop", attendees: 200, revenue: 10000 },
    { title: "Teams Integration Seminar", attendees: 150, revenue: 7500 },
    { title: "Power Platform Training", attendees: 100, revenue: 5000 },
  ],
};
                  ...
                  <Card className="h-full flex flex-col">
                    ...
                    <CardContent className="flex-1">
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 h-full">
                        ...
                        <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg col-span-2 md:col-span-3">
                          <DollarSign className="w-6 h-6 text-green-600 mx-auto mb-2" />
                          <div className="text-lg font-bold text-gray-900 dark:text-white">
                            {formatCurrency(companyStats.total_payments)}
                          </div>
                          <div className="text-sm text-gray-600 dark:text-gray-400">
                            Total Payments
                          </div>
