...
// Extended dummy data with subscription history
const organizationsData = {
  "org_123": {
    _id: "org_123",
    orgn_user: { _id: "orguser_456", name: "TechCorp Events" },
    bio: { description: "Leading tech event organizer specializing in cutting-edge technology conferences", website: "https://techcorp.com" },
    ...
    subscription_history: [
      ...
      {
        payment_plan: { plan_name: "Pro Plan" },
        billing_cycle: "monthly",
        price: 99,
  ...
  "org_124": {
    ...
    bio: { description: "Cutting-edge innovation events and startup showcases", website: "https://innovationlabs.io" },
    category: "company",
    subscription_status: "active",
  ...
  useEffect(() => {
    const loadOrganization = async () => {
      ...
      try {
        ...
        const orgData = organizationsData[params.id as keyof typeof organizationsData];
        if (orgData) {
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  {Math.round(organization.total_attendees / organization.total_events)} attendees
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Revenue per Event</span>
                <span className="font-medium text-gray-900 dark:text-white">
                  {formatCurrency(organization.total_revenue / organization.total_events)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Companies per Event</span>
                <span className="font-medium text-gray-900 dark:text-white">
                  {Math.round(organization.total_companies / organization.total_events)}
                </span>
              </div>
            </CardContent>
          </Card>
